...
def main():
    ...
    while running:
        ...
        if menu.menu_live:
            ...
            vjm_play.pause()
            level_1([size_hight, size_width],
                    balls_surfaces[menu.ball_index - 1], menu, rs_play)
            vjm_play.unpause()
            rs_play.pause()
        elif menu.level_2:
            vjm_play.pause()
            level_2([size_hight, size_width],
                    balls_surfaces[menu.ball_index - 1], menu, balls_surfaces, rs_play)
            vjm_play.unpause()
            rs_play.pause()
        elif menu.level_3:
            vjm_play.pause()
            level_3([size_hight, size_width],
                    balls_surfaces[menu.ball_index - 1], menu, balls_surfaces, rs_play)
            vjm_play.unpause()
            rs_play.pause()
        elif menu.level_4:
            vjm_play.pause()
            level_4([size_hight, size_width],
                    balls_surfaces[menu.ball_index - 1], menu, balls_surfaces, rs_play)
            vjm_play.unpause()
            rs_play.pause()
